module.exports = function(grunt) {
    ...
    grunt.initConfig({
            ...
            shell: {
                ...
                sass: {
                    dist: {
                        files: {
                            ...
                            // '<%= config.folder_dev %>/css/mobile.css': '<%= config.folder_assets %>/styles/mobile.scss', 
                            // '<%= config.folder_dev %>/css/oldbrowsers.css': '<%= config.folder_assets %>/styles/oldbrowsers.scss'
                        },
                        options: {
                            compass: true
                        }
                ...
                //             sassDir: '<%= config.folder_assets %>/styles',
                //             cssDir: '<%= config.folder_dev %>/css',
                ...
                //         options: {
                //             sassDir: '<%= config.folder_assets %>/styles',
                //             cssDir: '<%= config.folder_assets %>/styles'
                //         }
                //     }
                // },
